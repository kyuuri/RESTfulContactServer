...
public class ContactDaoTest {
	...
	public void setUp() {
		...
		contact1 = new Contact("contact1", "Joe Contact", "joe@microsoft.com","123456789");
		contact2 = new Contact("contact2", "Sally Contract", "sally@foo.com","4000000");
		contact3 = new Contact("contact3", "Foo Bar", "foo@barclub.com","12121212");
	}
	...
	//old updateTest, now the update changed so it falied.
	@Test
